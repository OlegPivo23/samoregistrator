...
export default defineConfig((/* ctx */) => {
  return {
    ...
    pwa: {
      workboxMode: 'GenerateSW', // Использование Workbox (GenerateSW или InjectManifest)
      swFilename: 'sw.js', // Имя service worker файла
      manifestFilename: 'manifest.json', // Имя манифеста
      injectPwaMetaTags: true, // Генерация мета-тегов для PWA
